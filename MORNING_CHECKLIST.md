...
ことでした。ただし**その時点では修正済みファイルをscpで実機に転送する前に
テストしてしまっていた可能性があります**(手順1のgit pullをすれば今回の
修正が反映されます)。急ぎではありませんが、もし気が向いたら`git pull`後に
もう一度だけCtrl+Qを試して、直っているか見てもらえると助かります。
